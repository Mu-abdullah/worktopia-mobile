...
class NewEmpTabletLayouts extends StatelessWidget {
  const NewEmpTabletLayouts({
    super.key,
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(child: EmpId(userID: empID, wanted: _wanted)),
                const SizedBox(width: 10),
                Expanded(child: EmpName(name: name, wanted: _wanted)),
              ],
            ),
            ...
            Row(
              children: [
                Expanded(child: EmpNID(nid: nid, wanted: _wanted)),
                const SizedBox(width: 10),
                Expanded(
